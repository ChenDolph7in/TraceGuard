...
from create_hierarchy_ckks import Structure
...
if __name__ == '__main__':
    ...
    for key, value in global_weights.items():
        encrypted_global_weights[key] = ts.ckks_tensor(context, value)
    structure = Structure(args, encrypted_global_weights, global_weights, global_model, context, test_dataset)
    ...
    for epoch in tqdm(range(args.epochs)):
        local_weights, local_encrypted_weights, local_losses = {}, {}, []
        ...
        for idx in idxs_users:
            ...
            if server_idx in local_weights.keys():
                local_encrypted_weights[server_idx].append((copy.deepcopy(encrypted_weights)))
                local_weights[server_idx].append((copy.deepcopy(w)))
            else:
                local_encrypted_weights[server_idx] = [copy.deepcopy(encrypted_weights)]
        ...
        structure.upload_weights(local_weights, local_encrypted_weights, global_round=epoch)
