...
class NN_Model(nn.Module):
    def __init__(self, in_feat=26, out_feat1=48, out_feat=24):
        super(NN_Model, self).__init__()

        # Define the layers
        self.fc1 = nn.Linear(in_feat, out_feat1)
        self.fc2 = nn.Linear(out_feat1, out_feat)
        self.fc3 = nn.Linear(out_feat, 1)
